...
{
    /// <summary>
    /// SendWhatsAppContactsMessageRequest
    /// </summary>
    public class WhatsAppContactsMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppContactsMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppContactsMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppContactsMessageRequest" /> class.
        /// </summary>
        ...
        public WhatsAppContactsMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppContactsContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppContactsContent Content { get; set; }
