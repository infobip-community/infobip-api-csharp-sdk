...
namespace Infobip.Api.Client.WhatsApp.Models
{
    ...
    public class WhatsAppInteractiveButtonsVideoHeaderContent : WhatsAppInteractiveButtonsHeaderContent, IValidatableObject
    {
        /// <summary>
        ...
        public WhatsAppInteractiveButtonsVideoHeaderContent(string mediaUrl = default, string type = default) : base()
        {
