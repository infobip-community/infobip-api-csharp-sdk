...
{
    /// <summary>
    /// SendWhatsAppInteractiveListMessageRequest
    /// </summary>
    public class WhatsAppInteractiveListMessageRequest : IValidatableObject
    {
        /// <summary>
        ...
        public WhatsAppInteractiveListMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppInteractiveListContent content = default, string callbackData = default)
        {
