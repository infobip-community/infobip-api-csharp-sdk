...
{
    /// <summary>
    /// SendWhatsAppStickerMessageRequest
    /// </summary>
    public class WhatsAppStickerMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppStickerMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppStickerMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppStickerMessageRequest" /> class.
        /// </summary>
        ...
        public WhatsAppStickerMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppStickerContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppStickerContent Content { get; set; }
