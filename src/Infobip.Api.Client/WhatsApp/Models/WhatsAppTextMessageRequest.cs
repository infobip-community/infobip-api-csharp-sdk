...
{
    /// <summary>
    /// SendWhatsAppTextMessageRequest
    /// </summary>
    public class WhatsAppTextMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppTextMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppTextMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppTextMessageRequest" /> class.
        /// </summary>
        ...
        public WhatsAppTextMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppTextContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppTextContent Content { get; set; }
