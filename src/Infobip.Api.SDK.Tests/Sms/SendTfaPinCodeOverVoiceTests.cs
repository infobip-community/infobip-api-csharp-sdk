...
{
    public class SendTfaPinCodeOverVoiceTests : IClassFixture<MockedHttpClientFixture>
    {
        private readonly MockedHttpClientFixture _clientFixture;

        public SendTfaPinCodeOverVoiceTests(MockedHttpClientFixture clientFixture)
        {
            _clientFixture = clientFixture;
        }

        [Fact]
        public async Task SendTfaPinCodeOverVoice_Call_ExpectsSuccess()
        {
            // Arrange
            var responsePayloadFileName = "Data/Sms/SendTfaPinCodeOverVoiceSuccess.json";
            ...
            // Act
            var response = await apiClient.Sms.SendTfaPinCodeOverVoice(request);
        ...
        [Fact]
        public async Task SendTfaPinCodeOverVoice_AppIdInvalid_Call_ThrowsException()
        {
            // Arrange
            var responsePayloadFileName = "Data/Sms/SendTfaPinCodeOverVoiceSuccess.json";
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responsePayloadFileName));
            ...
            // Act
            Func<Task> act = () => apiClient.Sms.SendTfaPinCodeOverVoice(request);
        ...
        [Fact]
        public async Task SendTfaPinCodeOverVoice_MessageIdInvalid_Call_ThrowsException()
        {
            // Arrange
            var responsePayloadFileName = "Data/Sms/SendTfaPinCodeOverVoiceSuccess.json";
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responsePayloadFileName));
        ...
        [Fact]
        public async Task SendTfaPinCodeOverVoice_ToInvalid_Call_ThrowsException()
        {
            // Arrange
            var responsePayloadFileName = "Data/Sms/SendTfaPinCodeOverVoiceSuccess.json";
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responsePayloadFileName));
