...
{
    public class SendWhatsAppAudioMessageTests : IClassFixture<MockedHttpClientFixture>
    {
        private readonly MockedHttpClientFixture _clientFixture;

        public SendWhatsAppAudioMessageTests(MockedHttpClientFixture clientFixture)
        {
        ...
        public async Task SendWhatsAppAudioMessage_Call_ExpectsSuccess()
        {
            ...
            var response = await apiClient.WhatsApp.SendWhatsAppAudioMessage(request);
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_BadRequestResponse_Throws_InfobipBadRequestException()
        {
            // Arrange
            var responsePayloadFileName = "Data/WhatsApp/SendWhatsAppAudioMessageBadRequest.json";
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responsePayloadFileName, HttpStatusCode.BadRequest));

            var request = GetRequest();

            // Act
            Func<Task> act = () => apiClient.WhatsApp.SendWhatsAppAudioMessage(request);
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_UnauthorizedResponse_Throws_InfobipUnauthorizedException()
        {
            // Arrange
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_TooManyRequestsResponse_Throws_InfobipTooManyRequestsException()
        {
            // Arrange
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_FromInvalidInRequest_Throws_InfobipRequestNotValidException()
        {
            // Arrange
            ...
            var request = new WhatsAppAudioMessageRequest("", "447860099300",
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_ToInvalidInRequest_Throws_InfobipRequestNotValidException()
        {
            // Arrange
            var responseMessage = GetResponseMessage();
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responseMessage));
            ...
            var content = new WhatsAppAudioContent("http://example.com/media");
            var request = new WhatsAppAudioMessageRequest("447860099299", "",
                Guid.NewGuid().ToString(),
                content);
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_MessageIdInvalidInRequest_Throws_InfobipRequestNotValidException()
        {
            // Arrange
            var responseMessage = GetResponseMessage();
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responseMessage));
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_CallbackDataInvalidInRequest_Throws_InfobipRequestNotValidException()
        {
            // Arrange
            var responseMessage = GetResponseMessage();
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responseMessage));
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_NotifyUrlInvalidInRequest_Throws_InfobipRequestNotValidException()
        {
            // Arrange
            var responseMessage = GetResponseMessage();
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responseMessage));
        ...
        [Fact]
        public async Task SendWhatsAppAudioMessage_Call_With_ContentInvalidInRequest_Throws_InfobipRequestNotValidException()
        {
            // Arrange
            var responseMessage = GetResponseMessage();
            var apiClient = new InfobipApiClient(_clientFixture.GetClient(responseMessage));

            var content = new WhatsAppAudioContent("");
            var request = new WhatsAppAudioMessageRequest("447860099299", "447860099300",
                Guid.NewGuid().ToString(),
                content);
            ...
            exception.ValidationResults.Should().HaveCountGreaterThan(0);
            var errors = exception.ValidationResults.SelectMany(result => result.MemberNames.Select(s => s)).ToArray();
            errors.Should().Contain($"{nameof(request.Content)}.{nameof(WhatsAppAudioContent.MediaUrl)}");
        }

        private WhatsAppAudioMessageRequest GetRequest()
        {
            var content = new WhatsAppAudioContent("http://example.com/media");
            var request = new WhatsAppAudioMessageRequest("447860099299", "447860099300",
                Guid.NewGuid().ToString(),
