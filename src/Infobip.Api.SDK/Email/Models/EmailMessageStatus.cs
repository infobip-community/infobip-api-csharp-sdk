...
namespace Infobip.Api.SDK.Email.Models
{
    ...
    public class EmailMessageStatus
    {
        ...
        public EmailMessageStatus(int groupId = default, string groupName = default, int id = default, string name = default, string description = default, string action = default)
        {
            GroupId = groupId;
            GroupName = groupName;
            Id = id;
