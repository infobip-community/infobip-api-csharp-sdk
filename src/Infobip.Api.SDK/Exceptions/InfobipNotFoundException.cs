...
{
    /// <summary>
    /// Represents errors that occur during api endpoints call execution in case when http response status code is <see cref="HttpStatusCode.NotFound"/>
    /// </summary>
    public class InfobipNotFoundException : InfobipException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InfobipNotFoundException"></see> class with a specified error message, message id and text.
        /// </summary>
