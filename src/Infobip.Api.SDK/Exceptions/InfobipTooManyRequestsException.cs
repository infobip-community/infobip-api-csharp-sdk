...
{
    /// <summary>
    /// Represents errors that occur during api endpoints call execution in case when http response status code is <c>TooManyRequests</c> (429).
    /// </summary>
    public class InfobipTooManyRequestsException : InfobipException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InfobipTooManyRequestsException"></see> class with a specified error message, message id and text.
        /// </summary>
