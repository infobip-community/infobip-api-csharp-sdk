...
namespace Infobip.Api.SDK.RCS.Models
{
    ...
    public class ReplySuggestion : Suggestion, IValidatableObject
    {
        /// <summary>
        ...
        public ReplySuggestion(string text = default, string postbackData = default, TypeEnum? type = default) : base()
        {
        }
