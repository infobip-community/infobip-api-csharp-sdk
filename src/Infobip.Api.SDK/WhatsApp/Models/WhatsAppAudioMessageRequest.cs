...
{
    /// <summary>
    /// SendWhatsAppAudioMessageRequest
    /// </summary>
    public class WhatsAppAudioMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppAudioMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppAudioMessageRequest() { }
        ...
        public WhatsAppAudioMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppAudioContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppAudioContent Content { get; set; }
