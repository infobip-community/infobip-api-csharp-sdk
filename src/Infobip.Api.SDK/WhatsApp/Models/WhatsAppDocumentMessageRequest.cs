...
{
    /// <summary>
    /// SendWhatsAppDocumentMessageRequest
    /// </summary>
    public class WhatsAppDocumentMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppDocumentMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppDocumentMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppDocumentMessageRequest" /> class.
        /// </summary>
        ...
        public WhatsAppDocumentMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppDocumentContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppDocumentContent Content { get; set; }
