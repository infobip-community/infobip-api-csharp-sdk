...
{
    /// <summary>
    /// SendWhatsAppImageMessageRequest
    /// </summary>
    public class WhatsAppImageMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppImageMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppImageMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppImageMessageRequest" /> class.
        /// </summary>
        ...
        public WhatsAppImageMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppImageContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppImageContent Content { get; set; }
