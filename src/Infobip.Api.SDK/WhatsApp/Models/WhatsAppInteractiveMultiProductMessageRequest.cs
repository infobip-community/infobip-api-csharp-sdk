...
namespace Infobip.Api.SDK.WhatsApp.Models
{
    ...
    public class WhatsAppInteractiveMultiProductMessageRequest
    {
        ...
        public WhatsAppInteractiveMultiProductMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppInteractiveMultiProductContent content = default, string callbackData = default, string notifyUrl = default)
        {
