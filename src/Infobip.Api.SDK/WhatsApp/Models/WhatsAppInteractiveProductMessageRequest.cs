...
{
    /// <summary>
    /// SendWhatsAppInteractiveProductMessageRequest
    /// </summary>
    public class WhatsAppInteractiveProductMessageRequest : IValidatableObject
    {
        /// <summary>
        ...
        public WhatsAppInteractiveProductMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppInteractiveProductContent content = default, string callbackData = default)
        {
