...
{
    /// <summary>
    /// WhatsAppInteractiveProductMessageRequest
    /// </summary>
    public class WhatsAppInteractiveProductMessageRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppInteractiveProductMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppInteractiveProductMessageRequest() { }
        ...
        public WhatsAppInteractiveProductMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppInteractiveProductContent content = default, string callbackData = default, string notifyUrl = default)
        {
        ...
        public WhatsAppInteractiveProductContent Content { get; set; }
