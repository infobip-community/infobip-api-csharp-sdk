...
{
    /// <summary>
    /// SendWhatsAppLocationMessageRequest
    /// </summary>
    public class WhatsAppLocationMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppLocationMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppLocationMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppLocationMessageRequest" /> class.
        /// </summary>
        ...
        public WhatsAppLocationMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppLocationContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppLocationContent Content { get; set; }
