...
{
    /// <summary>
    /// SendWhatsAppVideoMessageRequest
    /// </summary>
    public class WhatsAppVideoMessageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppVideoMessageRequest" /> class.
        /// </summary>
        [JsonConstructor]
        protected WhatsAppVideoMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WhatsAppVideoMessageRequest" /> class.
        /// </summary>
        ...
        public WhatsAppVideoMessageRequest(string from = default, string to = default, string messageId = default, WhatsAppVideoContent content = default, string callbackData = default)
        {
        ...
        public WhatsAppVideoContent Content { get; set; }
